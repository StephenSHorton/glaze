...
import { GlassSceneContext } from "./context";
...
export function GlassPanel({
  ...
  const frameRef = useRef({ radius, blur, bgBlur, refraction, dispersion, rim, colorRgb, tint, specular });
  frameRef.current = { radius, blur, bgBlur, refraction, dispersion, rim, colorRgb, tint, specular };
